def crearTriggers():
    ...
    #no funciona??
    db.executesql('CREATE TRIGGER trigger_bitacora_cantidad_update \
    BEFORE INSERT OR UPDATE ON t_bitacora \
    FOR EACH ROW EXECUTE PROCEDURE update_cantidad_bitacora();')
    return()
#crearTriggers()
